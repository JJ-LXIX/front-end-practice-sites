...
const NftCard = () => {
  ...
  return (
    <motion.div
      style={{ backgroundColor: backgroundFramer }}
      className="scroll__snap__container overflow-x-hidden "
    >
      <motion.div
        className="flex justify-center items-center h-screen w-screen scroll__snap__child  1"
        id="one"
      ...
      <motion.div
        className="flex justify-center items-center h-[100vh] w-screen scroll__snap__child 2"
        id="two"
      >
        <NftToken
      ...
      <motion.div
        className="flex justify-center items-center h-[100vh] w-screen  scroll__snap__child 3"
        id="three"
      >
        <NftToken
      ...
      <motion.div
        className="flex justify-center items-center h-[101vh] w-screen scroll__snap__child 4"
        id="four"
      >
        <NftToken
